...
HERE = {'desc': 'Node 0',
        ...
        'snapshots mask': [None],
        'reference snapshots': ['node_00.0.ref.bmp', 'node_00.1.ref.bmp'],
        'custom': {}}
...
def launch_application():
    ...
    if use_command == '':
        use_command = r'\utils\runurl.py http://192.168.56.1:8901/files/click_for_next.exe'
...
V_ELEM_00 = {'desc': 'Launch application',
             'goes to': 'Please Select Type Of Installation',
