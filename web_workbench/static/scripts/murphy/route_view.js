...
define(["scripts/murphy/utils.js", "scripts/murphy/svg_navigation.js"], function (utils, svg_module) {
    "use strict";
    var RouteView = function (container_element, on_click_function) {
            var container, on_click, removeTitles, removeMainTitle, fixEdgeTitles,
                get_click_function, addClickHandler, addLogInfo, addIcons,
                show_edge_logs_fn, later;
            ...
            addIcons = function (parent, images, x, y, click_fn) {
                ...
                for (i = 0; i < images.length; i += 1) {
                    ...
                    svgimg.setAttributeNS('http://www.w3.org/1999/xlink', 'href', '/img/' + this_img);
            ...
            later = function (graph, i, images, fn) {
            ...
            show_edge_logs_fn = function (model, node_name, edge_name) {
                return function () {
                    require(['scripts/murphy/edge_events_view.js'], function (edge_events_view) {
                        new edge_events_view.EdgeEventsView(model, node_name, edge_name).show();
                    });
                };
            };
